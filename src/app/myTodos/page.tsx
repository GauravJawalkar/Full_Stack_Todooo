...
function MyTodos() {
    ...
    return (
        <section>
            <div className="text-center text-4xl my-10 font-semibold">TASKS TO BE COMPLETED</div>
            <div className='grid grid-cols-4 max-sm:grid-cols-1 gap-10 p-10' >
                {
                    data.length > 0 ? data.map(({ _id, title, deadline }) => {
                        return (
                            <div className='w-full bg-[#1a1a1a] border p-4 rounded-xl' key={_id}>
                                ...
                                <div className="my-3">
                                    <button className='bg-neutral-900 hover:text-green-500 hover:ring-green-500 transition-all ease-linear font-semibold duration-200 ring-1 ring-gray-400 px-4 py-2 rounded mr-5'>
                                    ...
                                    <button className='bg-neutral-900 hover:text-red-500 hover:ring-red-500 hover:font-semibold transition-all ease-linear duration-200 ring-1 ring-gray-400 px-4 py-2 rounded' onClick={() => {
                                        deleteMe(_id);
                                    }}>
                        ...
                        <div className="animate-pulse transition-all ease-linear duration-200">
                            "NO TASKS REMAINING"
                        </div>
                }
            </div>
